...
And assesses how feasible it is for them to assemble into common geometric forms (edge-capped tetrahedrons / face-capped tetrahedrons, edge capped-cube, etc).
...
# Parse Molecules
molecule1_path <- system.file(package = "symbo", "fe_dummies.mol2")
molecule1 <- read_mol2(molecule1_path)

molecule2_path <- system.file(package = "symbo", "pd_dummies.mol2")
